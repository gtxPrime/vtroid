        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try (Response response = client.newCall(request).execute()) {
                    ...
                    Uri convertedSubtitleUri = com.gtxprime.vtroid.VideoPlayer.SubtitleUtils.convertInputStreamToUTF(activity, subtitleUri, inputStream);
                    ...
                    activity.runOnUiThread(() -> {
                        ...
                        if (PlayerActivity.playerVid != null) {
                            MediaItem mediaItem = PlayerActivity.playerVid.getCurrentMediaItem();
                            if (mediaItem != null) {
                                MediaItem.SubtitleConfiguration subtitle = com.gtxprime.vtroid.VideoPlayer.SubtitleUtils.buildSubtitle(activity, convertedSubtitleUri);
                                mediaItem = mediaItem.buildUpon().setSubtitleConfigurations(Collections.singletonList(subtitle)).build();
                                PlayerActivity.playerVid.setMediaItem(mediaItem, false);
