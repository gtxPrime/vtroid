...
class Prefs {
    ...
    public long getPosition() {
        ...
        if (ContentResolver.SCHEME_CONTENT.equals(mediaUri.getScheme())) {
            final String searchPath = com.gtxprime.vtroid.VideoPlayer.SubtitleUtils.getTrailPathFromUri(mediaUri);
            ...
            for (int i = keys.length; i > 0; i--) {
                ...
                if (ContentResolver.SCHEME_CONTENT.equals(uri.getScheme())) {
                    final String keyPath = com.gtxprime.vtroid.VideoPlayer.SubtitleUtils.getTrailPathFromUri(uri);
