...
import com.gtxprime.vtroid.Interfaces.VideoDownloader;
...
public class VimeoVideoDownloader implements VideoDownloader {
    ...
    private class Data extends AsyncTask<String, String,String> {
        ...
        protected void onPostExecute(String s) {
            ...
            {
                String videoTitle = "VimeoVideo" + new Date().toString() + ".mp4";
                try {
                    ...
                    request.setDescription("Downloading")
                            ...
                            .setDestinationInExternalPublicDir(DIRECTORY_DOWNLOADS, Utils.otherDirPath + videoTitle)
                    ...
                    Utils.mediaScanner(context, Utils.otherDirPath, videoTitle);
                } catch (Exception e) {
