...
public class Whatsapp_down_fragment extends Fragment implements MyStatusAdapter.OnCheckboxListener {
    ...
    public void populateGrid() {
        ...
        new Handler().postDelayed(() -> {
            ...
            myAdapter = new MyStatusAdapter(requireContext(), f, Whatsapp_down_fragment.this);
    ...
    public void getFromSdcard() {
        f = new ArrayList<>();
        if (RootDirectoryWhatsappShow.isDirectory()) {
            File[] listFile = RootDirectoryWhatsappShow.listFiles();
