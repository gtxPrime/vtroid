...
import static com.gtxprime.vtroid.Utils.Utils.RootDirectoryFacebookShow;
...
public class Facebook_down_fragment extends Fragment implements MyStatusAdapter.OnCheckboxListener {
    ...
    public void populateGrid() {
        ...
        new Handler().postDelayed(() -> {
            ...
            myAdapter = new MyStatusAdapter(requireContext(), f, Facebook_down_fragment.this);
    ...
    public void getFromSdcard() {
        f = new ArrayList<>();
        if (RootDirectoryFacebookShow.isDirectory()) {
            File[] listFile = RootDirectoryFacebookShow.listFiles();
