...
public class AdapterVideoFiles extends RecyclerView.Adapter<AdapterVideoFiles.ViewHolder2> {
    ...
    public AdapterVideoFiles(ArrayList<ModelMediaFiles> videoList, Context context, int viewType, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder2 holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (viewType == 0) {
            holder.menu_more.setOnClickListener(v -> {
                ...
                bsView.findViewById(R.id.bs_play).setOnClickListener(v15 -> {
                    holder.itemView.performClick();
                    bottomSheetDialog.dismiss();
                });

                bsView.findViewById(R.id.bs_rename).setOnClickListener(v14 -> {
                    bottomSheetDialog.dismiss();
                    Dialog renameDialog;
                    ...
                    renameYes.setOnClickListener(v141 -> {
                    ...
                    renameCancel.setOnClickListener(v1412 -> renameDialog.dismiss());
                    renameDialog.show();
                });

                bsView.findViewById(R.id.bs_share).setOnClickListener(v13 -> {
                ...
                bsView.findViewById(R.id.bs_delete).setOnClickListener(v12 -> {
                    bottomSheetDialog.dismiss();
                ...
                bsView.findViewById(R.id.bs_properties).setOnClickListener(v1 -> {
                    bottomSheetDialog.dismiss();
                    com.gtxprime.vtroid.Utils.VideoListHolder.videoList = videoList;
                    context.startActivity(new Intent(context, DeleteActivity.class)
                            .putExtra("position", position)
